...
function cacheFunction(cb) {
  ...
  correspondiente invocación a cb) de manera que, la próxima vez que reciba el mismo argumento, no sea necesario volver a invocar a cb, 
...
function textoUnderscore(cadena) {
